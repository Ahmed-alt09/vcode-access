...
class Admin {
	...
	public function admin_menu() {
		$hook_suffix = array();
		add_menu_page( __( 'Vatan SMS', 'wp-sms' ), __( '<img src="https://www.vatansms.com/assets/images/favicon.png" width="15"></img>VatanSMS', 'wp-sms' ), 'wpsms_sendsms', 'wp-sms', array( $this, 'send_sms_callback' ), 'dashicons-email-alt' );
		$hook_suffix['send_sms'] = add_submenu_page( 'wp-sms', __( 'SMS Gönder', 'wp-sms' ), __( 'SMS Gönder', 'wp-sms' ), 'wpsms_sendsms', 'wp-sms', array( $this, 'send_sms_callback' ) );
		add_submenu_page( 'wp-sms', __( 'SMS Raporları', 'wp-sms' ), __( 'SMS Raporları', 'wp-sms' ), 'wpsms_outbox', 'wp-sms-outbox', array( $this, 'outbox_callback' ) );

		$hook_suffix['subscribers'] = add_submenu_page( 'wp-sms', __( 'Aboneler', 'wp-sms' ), __( 'Aboneler', 'wp-sms' ), 'wpsms_subscribers', 'wp-sms-subscribers', array( $this, 'subscribers_callback' ) );
		$hook_suffix['groups']      = add_submenu_page( 'wp-sms', __( 'Gruplar', 'wp-sms' ), __( 'Gruplar', 'wp-sms' ), 'wpsms_subscribers', 'wp-sms-subscribers-group', array( $this, 'groups_callback' ) );
