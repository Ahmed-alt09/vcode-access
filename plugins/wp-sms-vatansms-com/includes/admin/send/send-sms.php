...
<div class="wrap">
    <h2><?php _e( 'SMS Gönder', 'wp-sms' ); ?></h2>
        ...
        <div class="meta-box-sortables">
            <div class="postbox">
                <h2 class="hndle" style="cursor: default;padding: 0 10px 10px 10px;font-size: 13px;">
                    <span><?php _e( 'SMS Gönderme Alanı ', 'wp-sms' ); ?></span></h2>
                ...
                <div class="inside">
                    <form method="post" action="">
                        ...
                        <table class="form-table">
                            <tr valign="top">
                                <th scope="row">
                                    <label for="wp_get_sender"><?php _e( 'GÖNDERİCİ ADI(SMS BAŞLIĞI)', 'wp-sms' ); ?>:</label>
                                </th>
                                <td>
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <label for="select_sender"><?php _e( 'Alıcı Seçimi', 'wp-sms' ); ?>:</label>
                                </th>
                                <td>
						...
						<span><?php echo sprintf( __( '<b>%s</b> Users have mobile number.', 'wp-sms' ), count( $get_users_mobile ) ); ?></span>
                                    ...
                                    <span class="wpsms-value wpsms-numbers">
                                        ...
                                        <div class="clearfix"></div>
                                        <span style="font-size: 14px"><?php echo sprintf( __( 'SMS göndereceğiniz telefon numaralarını aralarına virgül (,) koyarak veya alt alta yazın. 

Örnek telefon formatı 5553332211, 05553332211 veya 905553332211 ', 'wp-sms' ), $this->sms->validateNumber ); ?></span>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <label for="wp_get_message"><?php _e( 'SMS Mesaj İçeriği', 'wp-sms' ); ?>:</label>
                                </th>
                                <td>
                                    <textarea dir="auto" cols="80" rows="5" name="wp_get_message" id="wp_get_message"></textarea><br/>
                                    <p class="number">
										<?php echo __( '', 'wp-sms' ) . '' . $credit; ?> 
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <p class="submit" style="padding: 0;">
                                        <input type="submit" class="button-primary" name="SendSMS" value="<?php _e( 'SMS Gönder', 'wp-sms' ); ?>"/>
                                    </p>
                                </td>
                            </tr>
                        </table>
