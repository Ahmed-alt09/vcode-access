...
class Version {
	...
	public function pro_meta_links( $links, $file ) {
		if ( $file == 'wp-sms/wp-sms.php' ) {
			$links[] = sprintf( __( '<b><a href="vatansms.com" target="_blank" class="wpsms-plugin-meta-link wp-sms-pro" title="ÜCRETSİZ ÜYELİK">ÜCRETSİZ ÜYELİK</a></b>', 'wp-sms' ), WP_SMS_SITE . 'https://app.vatansms.com/register' );
		}
	...
	public function pro_setting_title() {
		echo sprintf( __( '<p>WP-SMS-Pro v</p>', 'wp-sms' ), WP_SMS_PRO_VERSION );
	}
	...
	public function pro_setting_title_pro_not_activated() {
		...
		if ( $this->pro_is_exists() ) {
			...
			$html .= '<a style="margin-bottom: 8px; font-weight: normal;" target="_blank" href="https://app.vatansms.com/register" class="button button-primary">' . __( 'ÜCRETSİZ ÜYELİK', 'wp-sms' ) . '</a>';
		}
	...
	public function setting_title_pro_not_activated() {
		if ( ! $this->pro_is_exists() ) {
			$html = '<a style="margin: 10px 0; font-weight: normal;" target="_blank" href="https://app.vatansms.com/register" class="button button-primary">' . __( 'ÜCRETSİZ ÜYELİK', 'wp-sms' ) . '</a>';
			echo $html;
		}
	}
	...
	*/
	public function version_notice() {
		Helper::notice( sprintf( __( 'The <a href="https://app.vatansms.com/" target="_blank">WP-SMS-Pro</a> is out of date and not compatible with new version of WP-SMS, Please update the plugin to the <a href="https://app.vatansms.com/" target="_blank">latest version</a>.', 'wp-sms' ), WP_SMS_SITE, 'https://app.vatansms.com/register' ), 'error' );
	}
	...
	public function license_notice() {
		...
		Helper::notice( sprintf( __( 'Please <a href="https://app.vatansms.com/">enter and activate</a> your license key for WP-SMS Pro to enable automatic updates.', 'wp-sms' ), $url ), 'error' );
	}
	...
	public function license_option( $option ) {
		...
		return array(
			'license_option' => array(
				'id'   => 'license_notice',
				'name' => __( 'License Keyv', 'wp-sms' ),
				'type' => 'notice',
				'desc' => sprintf( __( 'Please <a href="https://app.vatansms.com/">enter and activate</a> your license key for WP-SMS Pro to enable options.', 'wp-sms' ), $url ),
			)
		);
	}
}
