...
class Settings {
	...
	public function add_settings_menu() {
		add_submenu_page( 'wp-sms', __( 'Ayarlar', 'wp-sms' ), __( 'Ayarlar', 'wp-sms' ), 'wpsms_setting', 'wp-sms-settings', array(
			$this,
			'render_settings'
		) );
	}
	...
	public function get_tabs() {
		$tabs = array(
			'general'       => __( 'Yönetici Ayarları', 'wp-sms' ),
			'gateway'       => __( 'SMS Hesap Ayarları ', 'wp-sms' ),
			'newsletter'    => __( 'SMS Bülten Ayarları', 'wp-sms' ),
			'feature'       => __( 'Özellik Ayarları', 'wp-sms' ),
			'notifications' => __( 'Otomatik SMS Ayarları ', 'wp-sms' ),
			'integration'   => __( 'Contact Form 7 Ayarları ', 'wp-sms' ),
		);
	...
	public function settings_sanitize( $input = array() ) {
		...
		add_settings_error( 'wpsms-notices', '', __( 'Ayarlar güncellendi', 'wp-sms' ), 'updated' );
	...
	public function get_registered_settings() {
		...
		$settings = apply_filters( 'wp_sms_registered_settings', array(
			...
			'general'       => apply_filters( 'wp_sms_general_settings', array(
				'admin_title'         => array(
					'id'   => 'admin_title',
					'name' => __( 'Yönetici Cep Telefonu Tanımlama ', 'wp-sms' ),
					'type' => 'header'
				),
				'admin_mobile_number' => array(
					'id'   => 'admin_mobile_number',
					'name' => __( 'Yönetici cep telefonu numarası', 'wp-sms' ),
					'type' => 'text',
					'desc' => __( 'Herhangi bir sms bildirimi almak için yönetici cep telefonu numarası', 'wp-sms' )
				),
				'mobile_county_code'  => array(
					'id'   => 'mobile_county_code',
					'name' => __( 'Mobil ülke kodu', 'wp-sms' ),
					'type' => 'text',
					'desc' => __( 'Önek numaraları için mobil ülke kodunuzu girin. Örneğin +90 girerseniz Nihai sayı +909999999999 olur', 'wp-sms' )
				),
			...
			'gateway'       => apply_filters( 'wp_sms_gateway_settings', array(
				...
				'gayeway_title'             => array(
					'id'   => 'gayeway_title',
					'name' => __( 'VatanSMS Hesap Ayarları ', 'wp-sms' ),
					'type' => 'header'
				),
				'gateway_name'              => array(
					'id'      => 'gateway_name',
					'name'    => __( 'SMS Mesaj Merkezi ', 'wp-sms' ),
					'type'    => 'advancedselect',
					'options' => Gateway::gateway()
				),
				'gateway_kno'          => array(
					'id'   => 'gateway_kno',
					'name' => __( 'Müşteri Kodu ', 'wp-sms' ),
					'type' => 'text'
				),
				'gateway_username'          => array(
					'id'   => 'gateway_username',
					'name' => __( 'Kullanıcı adı', 'wp-sms' ),
					'type' => 'text'
				),
				'gateway_password'          => array(
					'id'   => 'gateway_password',
					'name' => __( 'Şifre', 'wp-sms' ),
					'type' => 'text'
				),
				'gateway_sender_id'         => array(
					'id'   => 'gateway_sender_id',
					'name' => __( 'GÖNDERİCİ ADI(SMS BAŞLIĞI)', 'wp-sms' ),
					'type' => 'text',
					'std'  => Gateway::from()
			...
			'newsletter'    => apply_filters( 'wp_sms_gateway_settings', array(
				...
				'newsletter_title'                => array(
					'id'   => 'newsletter_title',
					'name' => __( 'SMS Haber Bülteni', 'wp-sms' ),
					'type' => 'header'
				),
				'newsletter_form_groups'          => array(
					'id'   => 'newsletter_form_groups',
					'name' => __( 'Grupları Göster', 'wp-sms' ),
					'type' => 'checkbox',
					'desc' => __( 'Grupların Form üzerinde gösterilmesini etkinleştir.', 'wp-sms' )
				),
				'newsletter_form_verify'          => array(
					'id'   => 'newsletter_form_verify',
					'name' => __( 'Aboneyi Doğrula', 'wp-sms' ),
					'type' => 'checkbox',
					'desc' => __( 'Aktivasyon koduyla doğrulanmış abone olun', 'wp-sms' )
				),
				'welcome'                         => array(
					'id'   => 'welcome',
					'name' => __( 'Hoşgeldiniz SMS', 'wp-sms' ),
					'type' => 'header'
				),
				'newsletter_form_welcome'         => array(
					'id'   => 'newsletter_form_welcome',
					'name' => __( 'durum', 'wp-sms' ),
					'type' => 'checkbox',
					'desc' => __( 'Karşılama SMSini etkinleştirin veya devre dışı bırakın.', 'wp-sms' )
				),
				'newsletter_form_welcome_text'    => array(
					'id'   => 'newsletter_form_welcome_text',
					'name' => __( 'SMS metni', 'wp-sms' ),
					'type' => 'textarea',
					'desc' => sprintf( __( 'Abone adı: %s, Abone mobil: %s', 'wp-sms' ), '<code>%subscribe_name%</code>', '<code>%subscribe_mobile%</code>' )
				),
				'mobile_terms'                    => array(
					'id'   => 'mobile_terms',
					'name' => __( 'Cep Telefonu Numarası Şartları', 'wp-sms' ),
					'type' => 'header'
				),
			...
			'feature'       => apply_filters( 'wp_sms_feature_settings', array(
				'mobile_field'                     => array(
					'id'   => 'mobile_field',
					'name' => __( 'Cep Telefonu Numarası Alanı Ayarları ', 'wp-sms' ),
					'type' => 'header'
				),
				'add_mobile_field'                 => array(
					'id'      => 'add_mobile_field',
					'name'    => __( 'Cep telefonu numarası alanı ekle', 'wp-sms' ),
					'type'    => 'checkbox',
					'options' => $options,
					'desc'    => __( 'Kullanıcı profiline cep telefonu numarası ekleyin ve formu kaydedin.', 'wp-sms' )
				),
			...
			'notifications' => apply_filters( 'wp_sms_notifications_settings', array(
				...
				'notif_publish_new_post_title'            => array(
					...
					'name' => __( 'Yayınlanan yeni Postlar', 'wp-sms' ),
					'type' => 'header'
				),
				'notif_publish_new_post'                  => array(
					...
					'type'    => 'checkbox',
					'options' => $options,
					'desc'    => __( 'Yeni mesaj yayınlandığında abonelere SMS gönderin.', 'wp-sms' )
				),
				'notif_publish_new_post_words_count'     => array(
					'id'      => 'notif_publish_new_post_words_count',
					'name'    => __( 'Yazı içeriği kelime sayısı', 'wp-sms' ),
					'type'    => 'number',
					'desc'    => __( 'Gönderi gönderimi bildiriminde kırpma için kullanılan kelime sayısı. Varsayılan : 10', 'wp-sms' )
				),
				'notif_publish_new_post_template'         => array(
					'id'   => 'notif_publish_new_post_template',
					'name' => __( 'Mesaj', 'wp-sms' ),
					'type' => 'textarea',
					'desc' => __( 'SMS mesajının içeriğini girin.', 'wp-sms' ) . '<br>' .
					          sprintf(
				...
				'notif_register_new_user_title'           => array(
					...
					'name' => __( 'Yeni bir kullanıcı', 'wp-sms' ),
					'type' => 'header'
				),
				'notif_register_new_user'                 => array(
					...
					'type'    => 'checkbox',
					'options' => $options,
					'desc'    => __( 'WordPresse kaydolduğunuzda size ve kullanıcıya bir SMS gönderin.', 'wp-sms' )
				),
				'notif_register_new_user_admin_template'  => array(
					'id'   => 'notif_register_new_user_admin_template',
					'name' => __( 'Yönetici için mesaj', 'wp-sms' ),
					'type' => 'textarea',
					'desc' => __( 'SMS mesajının içeriğini girin.', 'wp-sms' ) . '<br>' .
					          sprintf(
						          __( 'Kullanıcı Girişi: %s, Kullanıcı e-postası: %s, Kayıt Tarihi: %s', 'wp-sms' ),
				...
				'notif_register_new_user_template'        => array(
					...
					'name' => __( 'Kullanıcı için mesaj', 'wp-sms' ),
					'type' => 'textarea',
					'desc' => __( 'SMS mesajının içeriğini girin.', 'wp-sms' ) . '<br>' .
					          sprintf(
						          __( 'Kullanıcı Girişi: %s, Kullanıcı e-postası: %s, Kayıt Tarihi: %s', 'wp-sms' ),
				...
				'notif_new_comment'                       => array(
					...
					'type'    => 'checkbox',
					'options' => $options,
					'desc'    => __( 'Size bir SMS gönderin Yeni bir yorum aldığınızda.', 'wp-sms' )
				),
				'notif_new_comment_template'              => array(
					...
					'desc' => __( 'SMS mesajının içeriğini girin.', 'wp-sms' ) . '<br>' .
					          sprintf(
						          __( 'Yorum yazarı: %s, Yazar e-postası: %s, Author url: %s, Author IP: %s, Yorum tarihi: %s, Yorum içeriği: %s', 'wp-sms' ),
				...
				'notif_user_login_title'                  => array(
					...
					'name' => __( 'Kullanıcı Girişi', 'wp-sms' ),
					'type' => 'header'
				),
				'notif_user_login'                        => array(
					...
					'type'    => 'checkbox',
					'options' => $options,
					'desc'    => __( 'Size bir SMS gönderin Kullanıcı oturum açtığında.', 'wp-sms' )
				),
				'notif_user_login_template'               => array(
					...
					'desc' => __( 'SMS mesajının içeriğini girin.', 'wp-sms' ) . '<br>' .
					          sprintf(
						          __( 'Kullanıcı adı: %s, ad ve soyadi: %s', 'wp-sms' ),
			...
			'integration'   => apply_filters( 'wp_sms_integration_settings', array(
				...
				'cf7_title'                    => array(
					'id'   => 'cf7_title',
					'name' => __( 'Contact Form 7 SMS Ayarları ', 'wp-sms' ),
					'type' => 'header'
				),
				'cf7_metabox'                  => array(
					'id'      => 'cf7_metabox',
					'name'    => __( 'SMS Alanı Ekle', 'wp-sms' ),
					'type'    => 'checkbox',
					'options' => $options,
					'desc'    => __( 'Seçildiğinde Contact Form 7 eklentisi içine Wordpress SMS Alanı (meta box) eklenir. 

Bildirim Ayarları ', 'wp-sms' )
				),
				/* Woocommerce
				//'wc_title'                     => array(
				//	'id'   => 'wc_title',
				...
				'edd_title'                    => array(
					'id'   => 'edd_title',
					'name' => __( 'Easy Digital Downloads SMS Ayarları', 'wp-sms' ),
					'type' => 'header'
				),
				'edd_notif_new_order'          => array(
					'id'      => 'edd_notif_new_order',
					'name'    => __( 'Yeni Sipariş', 'wp-sms' ),
					'type'    => 'checkbox',
					'options' => $options,
					'desc'    => __( 'Yeni sipariş alındığında kendine SMS gitsin.', 'wp-sms' )
				),
				'edd_notif_new_order_template' => array(
					'id'   => 'edd_notif_new_order_template',
					'name' => __( 'Mesaj İçeriği', 'wp-sms' ),
					'type' => 'textarea',
					'desc' => __( 'Mesaj içeriğini yazın', 'wp-sms' ) . '<br>' .
					          sprintf(
	...
	public function render_settings() {
        ...
        <div class="wrap wpsms-settings-wrap">
            ...
            <div class="wpsms-tab-group">
                <ul class="wpsms-tab">
                    <li id="wpsms-logo">
                        <img src="http://www.vatansms.com/assets/images/vatansms-logo.png">
                        <p>VatanSMS Wordpress</p>
